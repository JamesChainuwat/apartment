...
<body id="page-top">
                ...
                <div class="container-fluid">
                    <div class="col-md-12">
                        <div class="container-fluid mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="text-center mt-4 mb-4">ค่าเช่าค้างจ่าย</h4>
                                    <table class="table table-bordered bg-white" id="overdue">
                                        <thead>
                                            <tr>
                                                <th>รอบบิล</th>
                                                <th>เลขห้องเช่า</th>
                                        ...
                                        <tbody>
                                            ...
                                            INNER JOIN tbl_room_bill ON tbl_room_bill.user_id = tbl_user.user_id where tbl_room_bill.bill_status = '0' AND tbl_user.user_id = '$user_id'");
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#elec" data-id="<?= $data['bill_id']?>">
                                                        ตรวจสอบ
                                                    </button>
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#water" data-id="<?= $data['bill_id']?>">
                                                    ตรวจสอบ
                                                    </button>
                                                </td>
                                                <td>
                                                    ...
                                                    if($data['bill_status'] == 0){
                                                    ?>
                                                    <a href="pay_bill.php?id=<?= $data['bill_id']?>" type="button"
    ...
    $(document).ready(function() {
        $("#elec").on('show.bs.modal', function (event) {
        ...
        $("#water").on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget);
            var id = button.data('id');
