...
if($query) {
    $bill_water_img = base64_encode($query[0]['bill_water_img']);
    if(!empty($query[0]['bill_water_img'])){
        echo '<div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">รูปใบแจ้งค่าน้ำ</h5>
                <button type="button" class="close" data-bs-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <img src="data:image/jpeg;base64,'.$bill_water_img.'" class="img-fluid" id="modalImage" />
            </div>
