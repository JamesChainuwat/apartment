<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = getData("SELECT * FROM `tbl_admin` WHERE ad_name = '$ad_name'");

        if (!empty($query)) {
            // ใช้ข้อมูลของแถวแรกในกรณีที่มีหลายแถวที่ตรงเงื่อนไข
            $data = $query[0];
            if($data['ad_name'] == $ad_name){
        ...
        $sql="INSERT INTO `tbl_admin` (ad_name,ad_pass,ad_fname,ad_lname,ad_tel,ad_line,ad_img,ad_status)
        values('$ad_name','$ad_pass','$ad_fname','$ad_lname','$ad_tel','$ad_line','$imgadPicture','1')";
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="password" class="form-control" name="ad_pass" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ad_tel" required>
                            </div>
                            <div class="form-group">
                                <label>LINE</label>
                                <input type="text" class="form-control" name="ad_line" required>
                            </div>
                            <div class="form-group">
                                <label>รูปภาพ</label>
                            ...
                            <a class="btn btn-danger" href="admin.php" role="button">ยกเลิก</a>
                    </div>
                    </form>
                </div>
            </div>
