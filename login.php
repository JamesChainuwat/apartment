...
<style>
  * {
  ...
  .field input {
      ...
      border: unset;
      border-radius: 30px;
      outline-color: rgb(255 99 71 / 0.5);
            ...
            <div class="box-root flex-flex flex-direction--column" style="min-height: 100vh;flex-grow: 1;">
                <div class="loginbackground box-background--white padding-top--64">
                    <div class="loginbackground-gridContainer">
                        ...
                        <div class="box-root flex-flex" style="grid-area: 0 / start / auto / 4;">
                        ...
                        <div class="box-root flex-flex" style="grid-area: 7 / start / auto / 4;">
                            <div class="box-root box-background--pink animationLeftRight" style="flex-grow: 1;"></div>
                        </div>
                ...
                <div class="box-root padding-top--24 flex-flex flex-direction--column"
                    ...
                    <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center">
                        <h1 style="color:#63BAC4;">Thanapa Rental Room Management</h1>
                    </div>
                    <div class="formbg-outer">
                        <div class="formbg">
                            <div class="formbg-inner padding-horizontal--48">
                                <span class="padding-bottom--15" style="text-align:center;">Sign in to your
                                    account</span>
