    ...
    if($query[0]['type_pay'] == "โอนเงินผ่านธนาคาร"){
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" id="notConfirmButton" data-id="'.$id.'">Not confirmed</button>
                <button type="button" class="btn btn-success" id="confirmButton" data-id="'.$id.'">Confirm</button>
            </div>
        </div>
      </div>';
    }else{
